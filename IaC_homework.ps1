...
az group create -n myResourceGroupDev5 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev5 --template-uri $templateFile --parameters $devParameterFile --debug