...
az group create -n myResourceGroupDev2 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev2 --template-uri $templateFile --parameters $devParameterFile --debug