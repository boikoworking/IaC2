...
az group create -n myResourceGroupDev00 -l eastus00
az deployment group create --name devenvironment --resource-group myResourceGroupDev --template-file $templateFile --parameters $devParameterFile