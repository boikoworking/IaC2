...
az group create -n myResourceGroupDev30 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev30 --template-uri $templateFile --parameters $devParameterFile --debug