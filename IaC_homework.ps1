...
az group create -n myResourceGroupDev7 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev7 --template-uri $templateFile --parameters $devParameterFile --debug