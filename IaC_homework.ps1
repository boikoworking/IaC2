...
az group create -n myResourceGroupDev4 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev3 --template-uri $templateFile --parameters $devParameterFile --debug