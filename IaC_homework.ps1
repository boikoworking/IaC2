...
az group create -n myResourceGroupDev9 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev9 --template-uri $templateFile --parameters $devParameterFile --debug