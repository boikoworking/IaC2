...
az group create -n myResourceGroupDev00 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev00 --template-uri $templateFile --parameters $devParameterFile --debug