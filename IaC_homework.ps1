...
az group create -n myResourceGroupDev12 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev12 --template-uri $templateFile --parameters $devParameterFile --debug