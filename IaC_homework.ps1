...
az group create -n myResourceGroupDev11 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev11 --template-uri $templateFile --parameters $devParameterFile --debug