...
az group create -n myResourceGroupDev112 -l eastus
az deployment group create --debug -g myResourceGroupDev12 -n devenvironment -u $templateFile -p $devParameterFile