...
az group create -n myResourceGroupDev10 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev10 --template-uri $templateFile --parameters $devParameterFile --debug