...
az group create -n myResourceGroupDev8 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev8 --template-uri $templateFile --parameters $devParameterFile --debug