...
az group create -n myResourceGroupDev6 -l eastus
az deployment group create --name devenvironment --resource-group myResourceGroupDev6 --template-uri $templateFile --parameters $devParameterFile --debug